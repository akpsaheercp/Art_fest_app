            ...
            <div className="flex items-center gap-2 sm:gap-4">
                <div className="relative hidden md:block">
                    ...
                    <input 
                        ...
                        className="w-full max-w-xs pl-10 pr-4 py-2 rounded-full border border-zinc-300 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 transition-colors"
                    />
                </div>
